            ...
            s.jsxs)("div", {
                ...
                s.jsx)("ol", {
                    ...
                    children: [{
                        date: "2023 — Present",
                        company: {
                            name: "SUB4FIN LTD – London, UK",
                            link: "https://sub4fin.co.uk/"
                        },
                        positions: ["Backend Engineer"],
                        desc: "Architect and implement robust, cloud-native applications capable of handling high user volumes and ensuring exceptional user experience. Collaborate with frontend developers to optimize database queries, improving overall system performance.",
                        tech: ["JavaScript", "TypeScript", "Nodejs", "Git", "AWS", "Expressjs", "MongoDB", "Python"]
                    }, {
                        date: "2023 — Present",
                        company: {
                            name: "Remote",
                        },
                        positions: ["AWS Solutions Architect", "Freelance"],
                        desc: "Optimized application performance by implementing AWS auto-scaling groups and load balancers, resulting in a 50% reduction in response time. Assisted customers in designing serverless architectures using AWS Lambda and API Gateway.",
                        tech: ["EC2", "S3", "VPC", "RDS", "Lambda", "ECS", "Cloud Formation", "IAM", "Cloud Migration", "Cost Optimization", "ML"]
                    }, {
                        date: "Jan — Jun 2023",
                        company: {
                            name: "SUB4FIN LTD – London, UK",
                        ...
                        positions: ["AWS Solutions Architect", "Internship"],
                        desc: "Gained hands-on experience with AWS services such as EC2, S3, RDS, VPC, Serverless Architecture, Machine Learning, IAM, CloudWatch, ALB, Lambda, and CloudFormation, contributing to the development of robust cloud solutions.",
                        tech: ["EC2", "Load Balancing","S3", "VPC", "Serverless Architecture","RDS", "Lambda", "ECS", "Cloud Formation", "IAM", "Cloud Migration", "Cost Optimization", "ML"],
